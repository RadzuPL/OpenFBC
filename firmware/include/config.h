...
#define PIN_PWM_OUTPUT    2   // LEDC PWM output to ESC signal line
#define PIN_TRIGGER_INPUT 4   // Trigger / arming input (active HIGH)
#define PIN_VOLTAGE_ADC   1   // ADC input for LiPo voltage divider
